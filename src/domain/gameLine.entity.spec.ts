...
describe('GameLine', () => {
  ...
  describe('playerLine', () => {
    const playerLine = " 20:34 ClientUserinfoChanged: 2 n\\Isgalamido\\t\\0\\model"
  ...
  describe('killLine', () => {
    const killLineByWord = " 11:19 Kill: 1022 8 22: <world> killed Mal by MOD_TRIGGER_HURT"
    const killLineByPlayer = " 11:16 Kill: 6 3 10: Chessus killed Dono da Bola by MOD_RAILGUN"
